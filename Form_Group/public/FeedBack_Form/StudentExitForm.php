...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$email || !$name || !$branch || !$year || !$mobile || in_array(0, $answers, true)) {
        ...
        $stmt = mysqli_prepare($conn,
            ...
            (email,name,branch,year,feedback_type,mobile,
...
<head>
    ...
    <title>Student Exit Feedback Form</title>
...
<body>
    <div class="header">
        <h1>👋 Student Exit Feedback Form</h1>
        <p>Your valuable feedback helps us improve our institution</p>
    </div>
        ...
        <div class="card">
            ...
            <form method="POST" onsubmit="return validateForm()">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        <label for="year">Year of Passing <span class="required">*</span></label>
                ...
                <h2 class="section-title">⭐ Please Rate Your Experience (1-5)</h2>
