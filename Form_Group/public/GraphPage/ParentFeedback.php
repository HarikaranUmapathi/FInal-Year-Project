...
$responsesQuery = "SELECT * FROM parent_feedback ORDER BY submitted_at DESC LIMIT 100";
...
<head>
    ...
    <title>Parent Feedback - Analytics</title>
...
<body>
    <div class="header">
        <h1>📊 Parent Feedback Analytics</h1>
        <p>Comprehensive analysis of parent satisfaction and feedback</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="subtext">Parent feedback collected</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="subtext">Based on all 5 questions</div>
            </div>
        </div>
        ...
        <div class="data-table">
            <h3>📋 Detailed Parent Responses</h3>
            <table>
                <thead>
                    <tr>
                        <th>Parent Name</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><strong><?= htmlspecialchars($row['parent_name']) ?></strong></td>
    ...
    <script>
        ...
        new Chart(barCtx, {
            type: 'bar',
            data: {
                labels: ['Discipline', 'Infrastructure', 'Communication', 'Placement', 'Overall'],
                datasets: [{
                    label: 'Average Rating',
                    data: [<?= implode(',', $averages) ?>],
                    backgroundColor: ['#667eea', '#764ba2', '#8866c9', '#667eea', '#764ba2'],
                    borderRadius: 8,
                    borderSkipped: false
                }]
            },
