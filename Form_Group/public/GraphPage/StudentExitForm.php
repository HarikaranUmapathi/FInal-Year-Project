...
$responsesQuery = "SELECT * FROM student_exit_feedback ORDER BY submitted_at DESC LIMIT 100";
...
<head>
    ...
    <title>Student Exit Feedback - Analytics</title>
...
<body>
    <div class="header">
        <h1>📊 Student Exit Feedback Analytics</h1>
        <p>Comprehensive analysis of student feedback on institutional experience</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="subtext">Student exit surveys collected</div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="subtext">Based on all 12 questions</div>
            </div>
        </div>
    ...
    <script>
        ...
        new Chart(barCtx, {
            ...
            data: {
                labels: [
                    'Syllabus', 'Teaching', 'Lab', 'Library', 'Industry', 'Placement',
                    'Career', 'Soft Skills', 'Infrastructure', 'Campus', 'Admin', 'Overall'
                ],
                datasets: [{
                    label: 'Average Rating',
                    data: [<?= implode(',', $averages) ?>],
                    backgroundColor: [
                        '#667eea', '#764ba2', '#8866c9', '#667eea', '#764ba2', '#8866c9',
                        '#667eea', '#764ba2', '#8866c9', '#667eea', '#764ba2', '#8866c9'
                    ],
                    borderRadius: 8,
                    borderSkipped: false
